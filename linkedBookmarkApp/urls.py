...
urlpatterns = [
    ...
    url(r'^linked-resources/(?P<recource_id>\d+)/items/', views.ResourceItemList.as_view(), name='resource-list'),
    url(r'^linked-resources/(?P<recource_id>\d+)/items/(?P<recource_item_id>)/', views.ResourceItemDetail.as_view(), name='resource-detail'),
]